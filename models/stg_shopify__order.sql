...
final as (
    ...
    select 
        ...
        user_id,
        total_discounts,
        TO_JSON_STRING(total_discounts_set) as total_discounts_set,
        total_line_items_price,
        TO_JSON_STRING(total_line_items_price_set) as total_line_items_price_set,
        total_price,
        TO_JSON_STRING(total_price_set) as total_price_set,
        TO_JSON_STRING(total_tax_set) as total_tax_set,
        total_tax,
        source_name,
        subtotal_price,
        ...
        billing_address_zip,
        browser_ip,
        TO_JSON_STRING(total_shipping_price_set) as total_shipping_price_set,
