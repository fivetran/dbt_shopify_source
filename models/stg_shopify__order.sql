{% set source_columns = adapter.get_columns_in_relation(ref('stg_shopify__order_tmp')) %}
...
final as (
    ...
    select 
        ...
        user_id,
        total_discounts,
        {{ shopify_source.json_to_string("total_discounts_set", source_columns) }} as total_discounts_set,
        total_line_items_price,
        {{ shopify_source.json_to_string("total_line_items_price_set", source_columns) }} as total_line_items_price_set,
        total_price,
        {{ shopify_source.json_to_string("total_price_set", source_columns) }} as total_price_set,
        {{ shopify_source.json_to_string("total_tax_set", source_columns) }} as total_tax_set,
        total_tax,
        source_name,
        subtotal_price,
        ...
        billing_address_zip,
        browser_ip,
        {{ shopify_source.json_to_string("total_shipping_price_set", source_columns) }} as total_shipping_price_set,
