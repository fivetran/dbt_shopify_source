...
{% set columns = [
    ...
    {"name": "applied_discount_amount", "datatype": dbt_utils.type_float()},
    {"name": "applied_discount_applicable", "datatype": "boolean"},
    {"name": "applied_discount_description", "datatype": dbt_utils.type_string()},
    {"name": "applied_discount_non_applicable_reason", "datatype": dbt_utils.type_string()},
    {"name": "applied_discount_title", "datatype": dbt_utils.type_string()},
    {"name": "applied_discount_value", "datatype": dbt_utils.type_float()},
    {"name": "applied_discount_value_type", "datatype": dbt_utils.type_string()},
    {"name": "billing_address_address_1", "datatype": dbt_utils.type_string()},
    {"name": "billing_address_address_2", "datatype": dbt_utils.type_string()},
    {"name": "billing_address_city", "datatype": dbt_utils.type_string()},
    {"name": "billing_address_company", "datatype": dbt_utils.type_string()},
    ...
    {"name": "created_at", "datatype": dbt_utils.type_timestamp()},
    {"name": "credit_card_first_name", "datatype": dbt_utils.type_string()},
    {"name": "credit_card_last_name", "datatype": dbt_utils.type_string()},
    {"name": "credit_card_month", "datatype": dbt_utils.type_numeric()},
    {"name": "credit_card_number", "datatype": dbt_utils.type_numeric()},
    {"name": "credit_card_verification_value", "datatype": dbt_utils.type_string()},
    {"name": "credit_card_year", "datatype": dbt_utils.type_numeric()},
    {"name": "currency", "datatype": dbt_utils.type_string()},
    {"name": "customer_id", "datatype": dbt_utils.type_numeric()},
    ...
    {"name": "name", "datatype": dbt_utils.type_string()},
    {"name": "note", "datatype": dbt_utils.type_string()},
    {"name": "note_attribute_attributes_created_at_", "datatype": dbt_utils.type_numeric()},
    {"name": "note_attribute_attributes_mc_cid_", "datatype": dbt_utils.type_string()},
    {"name": "note_attribute_created_at", "datatype": dbt_utils.type_numeric()},
    {"name": "note_attribute_google_client_id", "datatype": dbt_utils.type_float()},
    {"name": "note_attribute_littledata_updated_at", "datatype": dbt_utils.type_numeric()},
    {"name": "note_attribute_mc_cid", "datatype": dbt_utils.type_string()},
    {"name": "note_attribute_updated_at", "datatype": dbt_utils.type_numeric()},
    {"name": "phone", "datatype": dbt_utils.type_string()},
    ...
    {"name": "shipping_address_country_code", "datatype": dbt_utils.type_string()},
    {"name": "shipping_address_first_name", "datatype": dbt_utils.type_string()},
    {"name": "shipping_address_id", "datatype": dbt_utils.type_numeric()},
    {"name": "shipping_address_last_name", "datatype": dbt_utils.type_string()},
    {"name": "shipping_address_latitude", "datatype": dbt_utils.type_string()},
    {"name": "shipping_address_longitude", "datatype": dbt_utils.type_string()},
    {"name": "shipping_address_name", "datatype": dbt_utils.type_string()},
    ...
    {"name": "shipping_address_province_code", "datatype": dbt_utils.type_string()},
    {"name": "shipping_address_zip", "datatype": dbt_utils.type_string()},
    {"name": "shipping_line", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_id", "datatype": dbt_utils.type_string()},
    {"name": "shipping_rate_price", "datatype": dbt_utils.type_float()},
    {"name": "shipping_rate_title", "datatype": dbt_utils.type_string()},
