...
## 🚨 Breaking Changes 🚨
- To reduce storage, updated default materialization of staging models to views. A `--full-refresh` will be required if you have previously run these staging models as tables.
